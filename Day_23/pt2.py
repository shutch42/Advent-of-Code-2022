# This is not a very efficient solution for part 2, it takes a few minutes to run.
# If I were to re-do this I would use either 2D arrays or hash maps to speed things up,
